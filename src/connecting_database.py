...
class DBManager:
    ...
    def get_companies_and_vacancies_count(self):
        ...
        conn = psycopg2.connect(database='coursework_hh_ru', **self.params)  # Данные БД
    ...
    def get_avg_salary(self):
        ...
        for i in rows:
            name_company = i[0]
            avg_salary = i[1]
            print(f'Средняя зарплата в компании {name_company} равняется {avg_salary} руб.')
    ...
    def get_vacancies_with_higher_salary(self):
        ...
        rows = cur.fetchall()
        print(f'Список вакансий, у которых харплата выше средней по всем вакансиям:')
        for i in rows:
